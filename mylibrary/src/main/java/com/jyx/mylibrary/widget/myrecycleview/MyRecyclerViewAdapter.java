...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    private MyRecyclerViewFooter recyclerViewFooter;
    ...
    public void setRecyclerViewFooter(MyRecyclerViewFooter recyclerViewFooter) {
        this.recyclerViewFooter = recyclerViewFooter;
    }

    public void setRecyclerViewHeader(MyRecyclerViewHeader recyclerViewHeader) {
    ...
    public MyRecyclerViewAdapter(Context context, RecyclerView.Adapter adapter) {
        mContext = context;
