...
/**
 * @author jyx
 * @ctime 2017/12/4:10:21
 * @explain SpannableString相关工具类
 */
...
public class SpannableStringUtils {
    ...
    public static class Builder {
        ...
        private boolean isVerticalCenterSpan = false;
        ...
        public Builder setVerticalCenterSpan(Boolean isVerticalCenterSpan) {
            this.isVerticalCenterSpan = isVerticalCenterSpan;
            return this;
        }
        ...
        private void setSpan(Context context) {
            ...
            if (isVerticalCenterSpan) {//垂直居中显示
                mBuilder.setSpan(new VerticalCenterSpan(), start, end, Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
                isVerticalCenterSpan = false;
            }
            if (isUnderline) {
